     ...
     <table class="table">
         ...
         <tbody>
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . $row['donor_organ'] . "</td>";
                echo "<td>" . $row['donor_bloodtype'] . "</td>";
                echo "<td>" . $row['donor_status'] . "</td>";
                echo "<td>";
                echo "<a href='edit_donor.php?donor_id=$row[donor_id]' class='btn btn-primary btn-sm'>Edit</a>";
               echo "</td>";
                echo "<td>";
               echo "<a href='delete_donor.php?donor_id=$row[donor_id]' class='btn btn-danger btn-sm'>Delete</a>";
               echo "</td>";
                echo "</tr>";
            }
?>
