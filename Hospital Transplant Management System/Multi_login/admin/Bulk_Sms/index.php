...
<head>
    ...
    <title>Patient SMS REMINDER</title>
</head>
            ...
            <div class="col-11 col-md-8 col-lg-6 col-xl-5">
                <form class="" method="POST" action="index.php">
                    <div class="card bg-dark">
                        <div class="row mt-0">
                            <div class="col-md-12 ">
                                <h4 class=""> PATIENT SMS REMINDER</h4>
<!--CODE TO SEND SMS-->  
<?php
if(isset($_POST['submit'])){
    ...
    curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type:application/json', 'h_api_key:278a348df2bf51c33234f64f50aec68b5618fa84cb35d18e57b89fd9ec7d6c3d'));
