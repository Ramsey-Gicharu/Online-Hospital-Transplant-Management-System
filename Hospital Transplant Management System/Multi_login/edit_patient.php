...
if($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    do{
        if( empty($patient_id) || empty($patient_name) || empty($patient_email) || empty($patient_phone) || empty($patient_organ) || empty($patient_bloodtype)){
            $errorMessage = "Please fill all fields";
            break;
        }
         $password = md5($password);//encrypt the password before saving in the database
        $sql= "UPDATE patients SET patient_name = '$patient_name', patient_email = '$patient_email', patient_phone = '$patient_phone', patient_organ = '$patient_organ', patient_bloodtype = '$patient_bloodtype' WHERE patient_id = $patient_id";
    ...
    <div class="container my-5">
     <?php
       ...
       ?>
        ...
        <button type="submit" class="btn btn-primary" href="/admin/index.php">SUBMIT</button>
         <button type="submit" class="btn btn-outline-primary" href="/admin/index.php">CLOSE</button>
